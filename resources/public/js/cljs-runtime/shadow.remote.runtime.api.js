...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31183 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31183(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31184 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31184(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31186 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31186(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31189 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31189(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31190 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31190(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31191 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31191(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31178,callback){
var map__31179 = p__31178;
var map__31179__$1 = cljs.core.__destructure_map(map__31179);
var input = map__31179__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31179__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31179__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
