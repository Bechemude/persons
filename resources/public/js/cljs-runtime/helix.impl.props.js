...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__38579_SHARP_,p2__38578_SHARP_){
return p2__38578_SHARP_.toUpperCase();
}));
...
while(true){
if(cljs.core.seq(m)){
var G__38603 = cljs.core.rest(m);
var G__38604 = (function (){var entry = cljs.core.first(m);
...
var G__38586 = o1;
goog.object.extend(G__38586,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38588_SHARP_){
if(cljs.core.map_QMARK_(p1__38588_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__38588_SHARP_);
} else {
return p1__38588_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__38609 = cljs.core.rest(m);
var G__38610 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__38613 = cljs.core.rest(m);
var G__38614 = (function (){var entry = cljs.core.first(m);
