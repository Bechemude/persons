...
var vec__26861 = module$node_modules$react$index.useState(initial);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26861,(0),null);
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26861,(1),null);
...
var G__26928__delegate = function (f,xs){
...
var G__26928 = function (f,var_args){
var xs = null;
...
while (G__26929__i < G__26929__a.length) {G__26929__a[G__26929__i] = arguments[G__26929__i + 1]; ++G__26929__i;}
  xs = new cljs.core.IndexedSeq(G__26929__a,0,null);
} 
return G__26928__delegate.call(this,f,xs);};
G__26928.cljs$lang$maxFixedArity = 1;
G__26928.cljs$lang$applyTo = (function (arglist__26930){
var f = cljs.core.first(arglist__26930);
var xs = cljs.core.rest(arglist__26930);
return G__26928__delegate(f,xs);
});
...
var G__26931 = null;
if (arguments.length > 1) {
var G__26932__i = 0, G__26932__a = new Array(arguments.length -  1);
while (G__26932__i < G__26932__a.length) {G__26932__a[G__26932__i] = arguments[G__26932__i + 1]; ++G__26932__i;}
G__26931 = new cljs.core.IndexedSeq(G__26932__a,0,null);
}
return helix$hooks$use_state_$_updater__2.cljs$core$IFn$_invoke$arity$variadic(f, G__26931);
}
...
if((ref.current == null)){
(ref.current = (function (){var x26870 = ({"current": x});
(x26870.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x26870.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x26870.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x26870.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return goog.object.set(this$__$1,"current",v);
}));

(x26870.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x26870.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return goog.object.set(this$__$1,"current",(function (){var G__26871 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__26871) : f.call(null,G__26871));
})());
}));

(x26870.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return goog.object.set(this$__$1,"current",(function (){var G__26872 = this$__$1.current;
var G__26873 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__26872,G__26873) : f.call(null,G__26872,G__26873));
})());
}));

(x26870.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return goog.object.set(this$__$1,"current",(function (){var G__26874 = this$__$1.current;
var G__26875 = a;
var G__26876 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__26874,G__26875,G__26876) : f.call(null,G__26874,G__26875,G__26876));
})());
}));

(x26870.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
 ...
 */
helix.hooks.use_subscription = (function helix$hooks$use_subscription(p__26909){
var map__26910 = p__26909;
var map__26910__$1 = cljs.core.__destructure_map(map__26910);
var get_current_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26910__$1,new cljs.core.Keyword(null,"get-current-value","get-current-value",-1706578691));
var subscribe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26910__$1,new cljs.core.Keyword(null,"subscribe","subscribe",416253756));
var vec__26914 = module$node_modules$react$index.useState((function (){
...
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26914,(0),null);
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26914,(1),null);
...
return (set_state.cljs$core$IFn$_invoke$arity$1 ? set_state.cljs$core$IFn$_invoke$arity$1(G__26922) : set_state.call(null,G__26922));
} else {
return null;
}
});
...
var value = (get_current_value.cljs$core$IFn$_invoke$arity$0 ? get_current_value.cljs$core$IFn$_invoke$arity$0() : get_current_value.call(null));
var G__26925_26940 = ({"get-current-value": get_current_value, "subscribe": subscribe, "value": value});
(set_state.cljs$core$IFn$_invoke$arity$1 ? set_state.cljs$core$IFn$_invoke$arity$1(G__26925_26940) : set_state.call(null,G__26925_26940));
