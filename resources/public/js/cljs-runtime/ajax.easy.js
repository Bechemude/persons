...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__38095 = cljs.core.second(format);
var G__38096 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__38095,G__38096) : ajax.easy.keyword_response_format_element.call(null,G__38095,G__38096));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38102_SHARP_){
return ajax.easy.keyword_response_format_element(p1__38102_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__38116){
var map__38117 = p__38116;
var map__38117__$1 = cljs.core.__destructure_map(map__38117);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38117__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38117__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38117__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__38118){
var vec__38119 = p__38118;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38119,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38119,(1),null);
var fexpr__38122_38161 = (cljs.core.truth_(ok)?h:e);
(fexpr__38122_38161.cljs$core$IFn$_invoke$arity$1 ? fexpr__38122_38161.cljs$core$IFn$_invoke$arity$1(result) : fexpr__38122_38161.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__38123){
var map__38124 = p__38123;
var map__38124__$1 = cljs.core.__destructure_map(map__38124);
var opts = map__38124__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38124__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38124__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38124__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38124__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38124__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
