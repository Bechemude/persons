...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__37195 = cljs.core.second(format);
var G__37196 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__37195,G__37196) : ajax.easy.keyword_response_format_element.call(null,G__37195,G__37196));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__37197 = format;
var G__37197__$1 = (((G__37197 instanceof cljs.core.Keyword))?G__37197.fqn:null);
switch (G__37197__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37198_SHARP_){
return ajax.easy.keyword_response_format_element(p1__37198_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__37199){
var map__37200 = p__37199;
var map__37200__$1 = cljs.core.__destructure_map(map__37200);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37200__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37200__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37200__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__37202){
var vec__37203 = p__37202;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37203,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37203,(1),null);
var fexpr__37206_37212 = (cljs.core.truth_(ok)?h:e);
(fexpr__37206_37212.cljs$core$IFn$_invoke$arity$1 ? fexpr__37206_37212.cljs$core$IFn$_invoke$arity$1(result) : fexpr__37206_37212.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__37207){
var map__37208 = p__37207;
var map__37208__$1 = cljs.core.__destructure_map(map__37208);
var opts = map__37208__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37208__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37208__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37208__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37208__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37208__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
