...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30943 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_30943(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30950 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_30950(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30952 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_30952(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30953 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_30953(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30954 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_30954(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30955 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_30955(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_30957 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_30957(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30958 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_30958(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30960 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_30960(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30961 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_30961(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30963 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_30963(b);
}
});
