...
var G__26197 = (i__4819__auto___26196 + (1));
i__4819__auto___26196 = G__26197;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26154){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26155,G__26156,seq26154__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__26171_SHARP_){
return (!((cljs.core.meta(p1__26171_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26174__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e26175){var _e__25373__auto__ = e26175;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e26179){var _e__25373__auto__ = e26179;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__26183 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__26184 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__26184);

try{var map__26185 = opts;
var map__26185__$1 = cljs.core.__destructure_map(map__26185);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26185__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__26183);
}});
...
var temp__5751__auto___26207 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___26207)){
var managed_print_level_26208 = temp__5751__auto___26207;
var _STAR_print_level_STAR__orig_val__26189_26209 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__26190_26210 = managed_print_level_26208;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__26190_26210);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__26186_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__26186_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__26189_26209);
}} else {
job_fn();
}
