...
var len__4818__auto___30330 = arguments.length;
var i__4819__auto___30331 = (0);
while(true){
if((i__4819__auto___30331 < len__4818__auto___30330)){
args__4824__auto__.push((arguments[i__4819__auto___30331]));

var G__30332 = (i__4819__auto___30331 + (1));
i__4819__auto___30331 = G__30332;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30288){
var G__30289 = cljs.core.first(seq30288);
var seq30288__$1 = cljs.core.next(seq30288);
var G__30290 = cljs.core.first(seq30288__$1);
var seq30288__$2 = cljs.core.next(seq30288__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30289,G__30290,seq30288__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30305_SHARP_){
return (!((cljs.core.meta(p1__30305_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30309__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30310){var _e__27286__auto__ = e30310;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e30313){var _e__27286__auto__ = e30313;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30318 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30319 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30319);

try{var map__30320 = opts;
var map__30320__$1 = cljs.core.__destructure_map(map__30320);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30320__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30318);
}});
...
var temp__5751__auto___30391 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___30391)){
var managed_print_level_30392 = temp__5751__auto___30391;
var _STAR_print_level_STAR__orig_val__30328_30393 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30329_30394 = managed_print_level_30392;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30329_30394);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30321_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30321_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30328_30393);
}} else {
job_fn();
}
