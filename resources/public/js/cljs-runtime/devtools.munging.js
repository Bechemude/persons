...
var o29804 = temp__5751__auto__;
var temp__5751__auto____$1 = (o29804["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o29805 = temp__5751__auto____$1;
return (o29805["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27279__auto__ = f;
return (o__27279__auto__["toString"]).call(o__27279__auto__);
} else {
return "";
}
...
try{var o__27279__auto___30025 = t;
(o__27279__auto___30025["cljs$lang$ctorPrWriter"]).call(o__27279__auto___30025,t,writer);
}catch (e29809){var __30026 = e29809;
}
...
var char_code = (function (){var o__27279__auto__ = (new String(char$));
return (o__27279__auto__["charCodeAt"]).call(o__27279__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27279__auto__ = String;
return (o__27279__auto__["fromCharCode"]).call(o__27279__auto__,subscript_code);
});
/**
...
var o__27279__auto__ = String;
return (o__27279__auto__["fromCharCode"]).call(o__27279__auto__,superscript_code);
});
/**
...
}catch (e29834){var _e__27286__auto__ = e29834;
return false;
}})())){
...
var vec__29835 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29835,(0),null);
...
var i__4819__auto___30034 = (0);
while(true){
if((i__4819__auto___30034 < len__4818__auto___30032)){
args__4824__auto__.push((arguments[i__4819__auto___30034]));

var G__30035 = (i__4819__auto___30034 + (1));
i__4819__auto___30034 = G__30035;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29846){
var vec__29847 = p__29846;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29847,(0),null);
...
var G__30036 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30037 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30036;
remaining_tokens = G__30037;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29838){
var G__29839 = cljs.core.first(seq29838);
var seq29838__$1 = cljs.core.next(seq29838);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29839,seq29838__$1);
}));
...
var vec__29860 = cljs.core.split_with((function (p1__29859_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29859_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29860,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29860,(1),null);
...
var vec__29882 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29882,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29882,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30041 = cljs.core.rest(remaining_tokens);
var G__30042 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30041;
name_tokens = G__30042;
continue;
} else {
...
var vec__29889 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29889,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29889,(1),null);
var vec__29892 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29892,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29892,(1),null);
var vec__29895 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29895,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29895,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29895,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29895,(3),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__29943 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29943,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29943,(1),null);
var vec__29946 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29946,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29946,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29962 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29962) : devtools.munging.parse_fn_info_deep.call(null,G__29962));
})()));
}
} else {
return fn_info;
...
var G__30046 = (arity + (1));
var G__30047 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29984){
var vec__29985 = p__29984;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29985,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29985,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29988_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29988_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29989_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29989_SHARP_);
}),sorted_infos);
...
var args__4824__auto__ = [];
var len__4818__auto___30060 = arguments.length;
var i__4819__auto___30061 = (0);
while(true){
if((i__4819__auto___30061 < len__4818__auto___30060)){
args__4824__auto__.push((arguments[i__4819__auto___30061]));

var G__30062 = (i__4819__auto___30061 + (1));
i__4819__auto___30061 = G__30062;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29992){
var vec__29993 = p__29992;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29993,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29990){
var G__29991 = cljs.core.first(seq29990);
var seq29990__$1 = cljs.core.next(seq29990);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29991,seq29990__$1);
}));
...
var map__30007 = options;
var map__30007__$1 = cljs.core.__destructure_map(map__30007);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30007__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30007__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30007__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30007__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30008 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30008,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30008,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30008,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30008,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30008,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30008,(5),null);
...
var o__27279__auto__ = f;
return (o__27279__auto__["getBasis"]).call(o__27279__auto__);
});
/**
...
}catch (e30011){var _e__27286__auto__ = e30011;
...
var G__30087 = (obj[cljs.core.first(path)]);
var G__30088 = cljs.core.rest(path);
obj = G__30087;
path = G__30088;
continue;
} else {
...
var _STAR_ = (function (accum,p__30012){
var vec__30013 = p__30012;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30013,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30013,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30016){
var vec__30017 = p__30016;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30017,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30017,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30017,(2),null);
...
var post_process = (function (p__30021){
var vec__30022 = p__30021;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30022,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30022,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30020_SHARP_){
return (obj[cljs.core.first(p1__30020_SHARP_)]);
}),sorted_matches);
