...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36659 = c;
var G__36659__$1 = (((G__36659 == null))?null:G__36659.prototype);
if((G__36659__$1 == null)){
return null;
} else {
return G__36659__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36660 = c;
var G__36660__$1 = (((G__36660 == null))?null:G__36660.prototype);
if((G__36660__$1 == null)){
return null;
} else {
return G__36660__$1.render;
}
})() == null)))));
});
...
var G__36668 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36668) : reagent.impl.component.as_element.call(null,G__36668));
};
...
var G__36669 = c;
var G__36669__$1 = (((G__36669 == null))?null:G__36669.constructor);
if((G__36669__$1 == null)){
return null;
} else {
return G__36669__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__36671 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36672 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36672);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36671);
}});
...
var c = this;
var G__36733_36750 = goog.object.get(c,"cljsRatom");
if((G__36733_36750 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36733_36750);
}
...
var renders_36751 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36752 = cljs.core.first(cljs.core.vals(renders_36751));
...
if((cljs.core.count(renders_36751) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36751))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36752)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36752], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__36741 = o;
goog.object.set(G__36741,cljs.core.name(k),v);
