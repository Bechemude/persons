...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_37613 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_37613(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_37614 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_37614(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_37616 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_37616(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_37617 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_37617(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_37618 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_37618(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_37627 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_37627(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_37628 = (function (this$,header){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_37628(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_37629 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_37629(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_37630 = (function (this$,request){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_37630(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_37632 = (function (this$,response){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_37632(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k37571,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37571,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__37582){
var vec__37583 = p__37582;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37583,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37583,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37570){
var self__ = this;
var G__37570__$1 = this;
return (new cljs.core.RecordIter((0),G__37570__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37572,other37573){
var self__ = this;
var this37572__$1 = this;
return (((!((other37573 == null)))) && ((((this37572__$1.constructor === other37573.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37572__$1.status,other37573.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37572__$1.body,other37573.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37572__$1.status_text,other37573.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37572__$1.headers,other37573.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37572__$1.was_aborted,other37573.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37572__$1.__extmap,other37573.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k37571){
var self__ = this;
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__37570){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__37603 = cljs.core.keyword_identical_QMARK_;
var expr__37604 = k__4470__auto__;
if(cljs.core.truth_((pred__37603.cljs$core$IFn$_invoke$arity$2 ? pred__37603.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__37604) : pred__37603.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__37604)))){
return (new ajax.protocols.Response(G__37570,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37603.cljs$core$IFn$_invoke$arity$2 ? pred__37603.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__37604) : pred__37603.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__37604)))){
return (new ajax.protocols.Response(self__.status,G__37570,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37603.cljs$core$IFn$_invoke$arity$2 ? pred__37603.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__37604) : pred__37603.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__37604)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__37570,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37603.cljs$core$IFn$_invoke$arity$2 ? pred__37603.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__37604) : pred__37603.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__37604)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__37570,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37603.cljs$core$IFn$_invoke$arity$2 ? pred__37603.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__37604) : pred__37603.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__37604)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__37570,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__37570),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__37570){
var self__ = this;
var this__4460__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__37570,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__37574){
var extmap__4501__auto__ = (function (){var G__37608 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__37574,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__37574),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__37574),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__37574),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__37574),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__37574),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
