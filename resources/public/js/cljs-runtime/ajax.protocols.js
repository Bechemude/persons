...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_36937 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_36937(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_36938 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_36938(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_36939 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_36939(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_36940 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_36940(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_36941 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_36941(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_36942 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_36942(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_36943 = (function (this$,header){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_36943(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_36944 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_36944(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_36945 = (function (this$,request){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_36945(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_36946 = (function (this$,response){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_36946(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k36923,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k36923,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__36928){
var vec__36929 = p__36928;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36929,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36929,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k36923){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k36923);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__36922){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__36933 = cljs.core.keyword_identical_QMARK_;
var expr__36934 = k__4470__auto__;
if(cljs.core.truth_((pred__36933.cljs$core$IFn$_invoke$arity$2 ? pred__36933.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__36934) : pred__36933.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__36934)))){
...
if(cljs.core.truth_((pred__36933.cljs$core$IFn$_invoke$arity$2 ? pred__36933.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__36934) : pred__36933.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__36934)))){
...
if(cljs.core.truth_((pred__36933.cljs$core$IFn$_invoke$arity$2 ? pred__36933.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__36934) : pred__36933.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__36934)))){
...
if(cljs.core.truth_((pred__36933.cljs$core$IFn$_invoke$arity$2 ? pred__36933.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__36934) : pred__36933.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__36934)))){
...
if(cljs.core.truth_((pred__36933.cljs$core$IFn$_invoke$arity$2 ? pred__36933.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__36934) : pred__36933.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__36934)))){
...
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__36922),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__36922){
var self__ = this;
...
var extmap__4501__auto__ = (function (){var G__36936 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__36926,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__36926)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__36936);
} else {
return G__36936;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__36926),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__36926),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__36926),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__36926),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__36926),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
