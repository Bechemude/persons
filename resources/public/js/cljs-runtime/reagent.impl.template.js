...
while (G__36777__i < G__36777__a.length) {G__36777__a[G__36777__i] = arguments[G__36777__i + 0]; ++G__36777__i;}
  args = new cljs.core.IndexedSeq(G__36777__a,0,null);
} 
...
var args = cljs.core.seq(arglist__36778);
...
var G__36754 = o;
goog.object.set(G__36754,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__36780__i < G__36780__a.length) {G__36780__a[G__36780__i] = arguments[G__36780__i + 0]; ++G__36780__i;}
  args = new cljs.core.IndexedSeq(G__36780__a,0,null);
} 
...
var args = cljs.core.seq(arglist__36781);
...
var G__36755 = props;
var G__36755__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36755,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36755);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36755__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__36755__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36756 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36756,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36756;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36757){
var map__36758 = p__36757;
var map__36758__$1 = cljs.core.__destructure_map(map__36758);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36758__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__36759_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36759_SHARP_);
}));
} else {
return null;
}
...
var vec__36761 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36761,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36761,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36761,(2),null);
...
var temp__5757__auto___36789 = reagent.impl.template.key_from_vec(v);
...
var temp__5757__auto___36795 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___36795 == null)){
} else {
var key_36796 = temp__5757__auto___36795;
(jsprops.key = key_36796);
}
...
var G__36765 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36765) : reagent.impl.template.as_element.call(null,G__36765));
} else {
var temp__5757__auto___36797 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___36797 == null)){
} else {
var key_36798 = temp__5757__auto___36797;
(jsprops.key = key_36798);
}
...
var G__36767 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__36767)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__36767)){
return x;
} else {
...
var len__4818__auto___36799 = arguments.length;
var i__4819__auto___36800 = (0);
while(true){
if((i__4819__auto___36800 < len__4818__auto___36799)){
args__4824__auto__.push((arguments[i__4819__auto___36800]));

var G__36801 = (i__4819__auto___36800 + (1));
i__4819__auto___36800 = G__36801;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36768){
var G__36769 = cljs.core.first(seq36768);
var seq36768__$1 = cljs.core.next(seq36768);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36769,seq36768__$1);
}));
...
break;
default:
var G__36804 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36804;
continue;
...
var ctx = ({});
var vec__36772 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36772,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36772,(1),null);
...
var G__36775 = (cljs.core.count(argv) - first_child);
switch (G__36775) {
case (0):
