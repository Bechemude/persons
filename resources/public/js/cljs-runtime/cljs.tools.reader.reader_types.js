...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26808 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26808(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26813 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26813(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26817 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26817(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26825 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26825(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26830 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26830(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26831 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26831(reader);
}
});
...
var G__26939 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26940 = s.append(c);
c = G__26939;
s = G__26940;
continue;
}
