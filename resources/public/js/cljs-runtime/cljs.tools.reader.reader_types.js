...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30763 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30763(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30764 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30764(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30765 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30765(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30766 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30766(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30767 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30767(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30768 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30768(reader);
}
});
...
var G__30781 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__30782 = s.append(c);
c = G__30781;
s = G__30782;
continue;
}
